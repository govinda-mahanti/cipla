...
<div className="bg-[#6A1916] text-white p-4 md:p-6 rounded-lg w-full">
  <div className="flex flex-wrap gap-4">
    <input
      ...
      className="bg-[#4B0F0D] text-white placeholder-gray-300 px-4 py-2 rounded w-full sm:w-64 focus:outline-none focus:ring-2 focus:ring-white"
    />
    <select
      className="bg-[#4B0F0D] text-white px-4 py-2 rounded w-full sm:w-64 focus:outline-none focus:ring-2 focus:ring-white"
    >
    ...
    <input
      type="text"
      placeholder="City"
      className="bg-[#4B0F0D] text-white placeholder-gray-300 px-4 py-2 rounded w-full sm:w-48 focus:outline-none focus:ring-2 focus:ring-white"
    />
    <button className="p-2 border border-white rounded self-start hover:bg-white hover:text-[#6A1916] transition-all">
